...
string cs1 = "server=DESKTOP-VKVQK92\\SQLEXPRESS;integrated security=true;database=pharmacydb;";
builder.Services.AddDbContext<pharmacydbContext>(options => options.UseSqlServer(cs1));
